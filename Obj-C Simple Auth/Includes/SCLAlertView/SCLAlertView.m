...
- (void)setupViewWindowWidth:(CGFloat)windowWidth
{
    ...
    // Content View
    _contentView.backgroundColor = UIColorFromHEX(0x131A22);
    ...
    // Colors
    self.backgroundViewColor = UIColorFromHEX(0x131A22);
    _labelTitle.textColor = UIColorFromHEX(0xFFFFFF); //Dark Grey
    _viewText.textColor = UIColorFromHEX(0xFFFFFF); //Dark Grey
    _contentView.layer.borderColor = UIColorFromHEX(0x131A22).CGColor; //Light Grey
}
